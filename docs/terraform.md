...
| <a name="input_ec2_autoscaling_role_enabled"></a> [ec2\_autoscaling\_role\_enabled](#input\_ec2\_autoscaling\_role\_enabled) | If set to `false`, will use variable `existing_ec2_autoscaling_role_arn` using an existing IAM role that was created outside of this module | `bool` | `true` | no |
| <a name="input_ec2_role_enabled"></a> [ec2\_role\_enabled](#input\_ec2\_role\_enabled) | If set to `false`, will use variable `existing_ec2_role_arn` & `existing_ec2_instance_profile_arn` using an existing IAM role & instance profile that was created outside of this module | `bool` | `true` | no |
| <a name="input_enabled"></a> [enabled](#input\_enabled) | Set to false to prevent the module from creating any resources | `bool` | `null` | no |
| <a name="input_environment"></a> [environment](#input\_environment) | ID element. Usually used for region e.g. 'uw2', 'us-west-2', OR role 'prod', 'staging', 'dev', 'UAT' | `string` | `null` | no |
| <a name="input_existing_ec2_autoscaling_role_arn"></a> [existing\_ec2\_autoscaling\_role\_arn](#input\_existing\_ec2\_autoscaling\_role\_arn) | ARN of your existing ec2 autoscaling role to attach to the cluster | `string` | `""` | no |
| <a name="input_existing_ec2_instance_profile_arn"></a> [existing\_ec2\_instance\_profile\_arn](#input\_existing\_ec2\_instance\_profile\_arn) | ARN of your existing ec2 instance profile created from `existing_ec2_role_arn` | `string` | `""` | no |
| <a name="input_existing_ec2_role_arn"></a> [existing\_ec2\_role\_arn](#input\_existing\_ec2\_role\_arn) | ARN of your existing ec2 role to attach to the cluster | `string` | `""` | no |
| <a name="input_existing_service_role_arn"></a> [existing\_service\_role\_arn](#input\_existing\_service\_role\_arn) | ARN of your existing EMR service role to attach to the cluster | `string` | `""` | no |
...
| <a name="input_service_role_enabled"></a> [service\_role\_enabled](#input\_service\_role\_enabled) | If set to `false`, will use variable `existing_service_role_arn` using an existing IAM role that was created outside of this module | `bool` | `true` | no |
