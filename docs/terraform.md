...
| <a name="input_custom_ec2_autoscaling_role"></a> [custom\_ec2\_autoscaling\_role](#input\_custom\_ec2\_autoscaling\_role) | ARN of your custom ec2 autoscaling role to attach to the cluster | `string` | `""` | no |
| <a name="input_custom_ec2_instance_profile"></a> [custom\_ec2\_instance\_profile](#input\_custom\_ec2\_instance\_profile) | ARN of your custom ec2 instance profile created from `custom_ec2_role` | `string` | `""` | no |
| <a name="input_custom_ec2_role"></a> [custom\_ec2\_role](#input\_custom\_ec2\_role) | ARN of your custom ec2 role to attach to the cluster | `string` | `""` | no |
| <a name="input_custom_service_role"></a> [custom\_service\_role](#input\_custom\_service\_role) | ARN of your custom EMR service role to attach to the cluster | `string` | `""` | no |
...
| <a name="input_use_custom_ec2_autoscaling_role"></a> [use\_custom\_ec2\_autoscaling\_role](#input\_use\_custom\_ec2\_autoscaling\_role) | If set to `true`, will use variable `custom_ec2_autoscaling_role` using an existing IAM role that was created outside of this module | `bool` | `false` | no |
| <a name="input_use_custom_ec2_role"></a> [use\_custom\_ec2\_role](#input\_use\_custom\_ec2\_role) | If set to `true`, will use variable `custom_ec2_role` & `custom_ec2_instance_profile` using an existing IAM role & instance profile that was created outside of this module | `bool` | `false` | no |
| <a name="input_use_custom_service_role"></a> [use\_custom\_service\_role](#input\_use\_custom\_service\_role) | If set to `true`, will use variable `custom_service_role` using an existing IAM role that was created outside of this module | `bool` | `false` | no |
